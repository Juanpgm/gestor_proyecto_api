...
try:
    ...
    async def get_unidades_proyecto_quality_metrics(
        nombre_centro_gestor: Optional[str] = None, history_limit: Optional[int] = None
    ):
        return {
            "success": False,
            "error": "Unidades proyecto quality metrics not available",
        }

    async def generate_unidades_proyecto_quality_report(
        nombre_centro_gestor: Optional[str] = None, persist: bool = True
    ):
        return {
            "success": False,
            "error": "Unidades proyecto quality metrics not available",
...
try:
    ...
    async def get_contratos_init_data(filters=None):
        return {
            "success": False,
            "error": "Contratos operations not available",
            "data": [],
            "count": 0,
        }
...
try:
    ...
    async def create_reporte_contrato(reporte_data):
        return {
            "success": False,
            "error": "Reportes contratos operations not available",
        }
    ...
    async def delete_reporte_contrato(reporte_id):
        return {
            "success": False,
            "error": "Reportes contratos operations not available",
        }
...
try:
    ...
    async def obtener_datos_secop(
        referencia_proceso: str, nit_entidad: Optional[str] = None
    ):
        return {"success": False, "error": "Emprestito operations not available"}
    ...
    async def actualizar_proceso_emprestito(
        ...
        bp=None,
        nombre_resumido_proceso=None,
        id_paa=None,
        valor_proyectado=None,
    ):
        return {"success": False, "error": "Emprestito operations not available"}

    async def obtener_codigos_contratos(
        referencia_proceso: str, proceso_contractual: str
    ):
        return {"success": False, "error": "Emprestito operations not available"}
    ...
    def cargar_pago_emprestito(datos_pago):
        return {"success": False, "error": "Emprestito operations not available"}

    async def get_pagos_emprestito_all():
        return {
            "success": False,
            "error": "Emprestito operations not available",
            "data": [],
            "count": 0,
        }
    ...
    async def actualizar_rpc_contrato_emprestito(
        numero_rpc: str, datos_actualizacion: dict
    ):
        return {"success": False, "error": "Emprestito operations not available"}
    ...
    async def buscar_y_poblar_contratos_secop(
        referencia_proceso: str, proceso_contractual: str
    ):
        return {"success": False, "error": "Emprestito operations not available"}
    ...
    async def obtener_datos_secop_completos(
        referencia_proceso: str, nit_entidad: Optional[str] = None
    ):
        return {"success": False, "error": "Emprestito operations not available"}
    ...
    async def actualizar_proyeccion_emprestito(
        referencia_proceso: str, datos_actualizacion: dict
    ):
        return {"success": False, "error": "Emprestito operations not available"}
...
try:
    ...
    async def process_proyectos_presupuestales_json(
        proyectos_data, update_mode="merge"
    ):
        return {
            "success": False,
            "error": "Proyectos presupuestales operations not available",
        }
...
try:
    ...
    async def get_ordenes_compra_emprestito_all():
        return {
            "success": False,
            "error": "Ordenes compra operations not available",
            "data": [],
            "count": 0,
        }
...
try:
    ...
    async def generate_emprestito_quality_report(
        nombre_centro_gestor=None, persist=True
    ):
        return {"success": False, "error": "Emprestito quality metrics not available"}

    async def get_emprestito_quality_summary(
        report_id=None, nombre_centro_gestor=None, auto_generate=False
    ):
        return {"success": False, "error": "Emprestito quality metrics not available"}

    async def get_emprestito_quality_records(
        report_id=None, page=1, limit=50, centro_gestor=None, tipo_registro=None
    ):
        return {"success": False, "error": "Emprestito quality metrics not available"}
...
try:
    ...
    async def get_flujo_caja_from_firebase(filters=None):
        return {
            "success": False,
            "error": "Flujo caja operations not available",
            "data": [],
            "count": 0,
        }
